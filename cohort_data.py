def unique_houses(filename):
    ...
    houses = set()
#open file and create a list of student record rows
...
def sort_by_cohort(filename):
    ...
    for line in cohort_file:
        line = line.rstrip()
        student_record = line.split("|")
        student_full_name = student_record[0] + " " + student_record[1]
        if (student_record[4] == 'Winter 2015'):
            winter_15.append(student_full_name) 
        elif (student_record[4] == 'Spring 2015'):
            spring_15.append(student_full_name)
        elif (student_record[4] == 'Summer 2015'):
            summer_15.append(student_full_name)
        elif (student_record[4] == 'TA'):
...
def students_by_house(filename):
    ...
    for line in house_file:
        line = line.rstrip()
        student_record = line.split("|")
        student_last_name = student_record[1]
        if (student_record[2] == 'Gryffindor'):
        ...
        elif (student_record[2] == "Dumbledore's Army"):
            dumbledores_army.append(student_last_name)
        elif (student_record[2] == 'Order of the Phoenix'):
...
def all_students_tuple_list(filename):
    ...
    # create a tuple of strings holding full name, house, advisor first name, cohort
    # do not include instructor or TA
